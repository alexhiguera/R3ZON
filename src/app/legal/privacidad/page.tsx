...
export default function Page() {
  return (
    <LegalDoc eyebrow="RGPD · LOPDGDD" title="Política de Privacidad">
      ...
      <UL>
        <li>
          <b>Datos de cuenta:</b> nombre, email, contraseña cifrada, nombre del
          negocio.
        </li>
        <li>
          <b>Datos de uso:</b> dirección IP, dispositivo, navegador, fecha y
          hora de acceso.
        </li>
        <li>
          <b>Datos comerciales:</b> los que tú introduces sobre tus clientes,
          citas, tareas y finanzas (eres el <i>responsable</i> y nosotros
          actuamos como <i>encargado</i>).
        </li>
      </UL>
      ...
      <UL>
        ...
        <li>
          <b>Seguridad y prevención de fraude</b> (registro de dispositivos,
          alertas) — base: interés legítimo (art. 6.1.f).
        </li>
        <li>
          <b>Cumplimiento legal</b> (facturación, conservación contable) — base:
          obligación legal (art. 6.1.c).
        </li>
        <li>
          <b>Comunicaciones comerciales</b> — base: consentimiento (art. 6.1.a),
      ...
      <p>
        Los datos se conservarán mientras se mantenga la relación contractual y,
        posteriormente, durante los plazos legales aplicables (p. ej. 6 años
        para documentos contables, art. 30 Código de Comercio).
      </p>

      <H2>5. Destinatarios y transferencias</H2>
      <UL>
        <li>
          <b>Supabase Inc.</b> (proveedor de base de datos y autenticación,
          servidores en la UE).
        </li>
        <li>
        ...
        <li>
          Proveedores de identidad federada (Google, Apple, Facebook) si decides
      ...
      <p>
        Para ejercerlos, escríbenos a <b>privacidad@r3zon.app</b> aportando
        copia de tu DNI o documento equivalente.
      </p>

      <H2>7. Medidas de seguridad</H2>
      <p>
        Aplicamos cifrado en tránsito (TLS 1.3) y en reposo (AES-256), aislamiento
        multi-tenant mediante Row Level Security, contraseñas con hash bcrypt y
